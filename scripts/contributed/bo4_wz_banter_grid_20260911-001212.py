...
B = chr(92)
spk = ["prop","batt","ruin","fire","zero","spec","reap","noma","outr","sera","tedd","mist","stuh","ptak","russ","marl","matt","wood","alex","huds","pnik","pdem","cras","engi","rezn","swat","pric","reco","bom1","bom2","bom3","bom4","bop1","bop2","bop3","bop4","bop5","bof1","bof2","bof3","bof4","weav","yuri","udem","utak","uric","unik","mene","sara","blac","ctre","cpri","zmm1","zmf1","serg","ward","numb","ajax","torq","dmas","sman","repl","cgor","bza"]
for a in spk:
    for b in spk:
        if a == b: continue
        c1, c2 = sorted([a, b])
